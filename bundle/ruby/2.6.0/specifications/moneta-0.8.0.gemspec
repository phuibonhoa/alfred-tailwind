...
Gem::Specification.new do |s|
  ...
  s.authors = ["Daniel Mendler".freeze, "Yehuda Katz".freeze, "Hannes Georg".freeze]
  s.date = "2014-07-06"
  s.description = "A unified interface to key/value stores".freeze
  s.email = ["mail@daniel-mendler.de".freeze, "wycats@gmail.com".freeze, "hannes.georg@googlemail.com".freeze]
